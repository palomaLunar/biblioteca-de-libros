...
class usuario
{
  ...
  public function getPro_direccion(): ?DateTime
  {
    return $this->usu_direccion;
  }
  public function setPro_direccion(DateTime $direccion)
  {
  ...
  {
    return $this->usu_fecha_inscripcion;
  }
  public function setPro_fecha(string $fecha)
  {
    $this->usu_fecha_inscripcion = $fecha;
  }
  ...
  {
    try {
      $sql = "INSERT INTO libros (id_usuario, nombre, apellido, direccion, telefono, correo, fecha_inscripcion) VALUES ( :id_usuario, :nombre, :apellido, :direccion, :telefono, :correo, :_fecha_inscripcion";
      $consulta = $this->pdo->prepare($sql);
      $consulta->bindParam("id_usuario", $p->getPro_id());
      ...
      $consulta->bindParam(":fecha_inscripcion", $p->getPro_fecha());
      $consulta->execute();
    } catch (Exception $e) {
      die($e->getMessage());
    }
  ...
  public function Obtener($id)
  {
    try {
      ...
      $p->setPro_fecha($res->fecha_inscripcion);
      return $p;
  ...
  {
    try {
      $sql = "UPDATE usuario SET nombre = :nombre,apellido = :apellido, direccion = :direccion, telefono = :telefono, correo = :correo, fecha_inscripcion = :fecha_inscripcion WHERE id_usuario = :id_usuario";
      $consulta = $this->pdo->prepare($sql);
      $consulta->bindParam(":id_usuario", $p->getPro_id());
      $consulta->bindParam(":nombre", $p->getPro_nombre());
      $consulta->bindParam(":apellido", $p->getPro_apellido());
