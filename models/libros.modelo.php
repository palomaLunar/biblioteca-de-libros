...
class Libro
{
  ...
  {
    return $this->lib_id_libro;
  }
  public function setPro_id(int $id)
  {
    $this->lib_id_libro = $id;
  }
  ...
  {
    try {
      $sql = "INSERT INTO libros (id_libro, titulo, autor, genero, anio, isbn, cantidad) VALUES (:id_libro, :titulo, :autor, :genero, :anio, :isbn, :cantidad)";
      $consulta = $this->pdo->prepare($sql);
      $consulta->bindParam(":id_libro", $p->getPro_id());
